...
if not os.path.exists('/tmp/classifi/models'):
    os.makedirs('/tmp/classifi/models')
...
def parse_args(argv):
    ...
    parser.add_argument('-grpA',
                        '--grpA',
                        help='A group A folder path e.g hotels')
    parser.add_argument('-grpB',
                        '--grpB',
    ...
    parser.add_argument('-pid',
                        '--pid',
                        help='A string indicating process id',
                        default='no')
...
def main(argv=sys.argv):
    ...
    if action == 'train':
        ...
        if not new_model:
            ...
            print("Please provide a model name to train")
        ...
        if not model:
            print("You are required to provide a trained model to proceed")
            sys.stdout.flush()
            return
